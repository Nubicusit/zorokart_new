...
<div class="content-wrapper">
    ...
    <?php endif; ?>
            <div class=" mb-2 " style=" display:flex; align-items:center">
                ...
                <h3 style="text-align:center">Main Category</h3>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card mt-3 mb-3 pl-3 pr-3 py-3">
                ...
                <form action="<?php echo e(url('course_search')); ?>" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <div class="card-body table-responsive p-b-0">
                                ...
                                <table class="table table-hover text-nowrap">
                                    ...
                                    <tbody class="cur-body">
                                      ...
                                      src="<?php echo e(url('public/images/category/'.$c->image.'')); ?>">
                                </td>

                                                <td><?php echo e(__($c->name)); ?></td>
<td><?php echo e(__($c->caption)); ?></td>
<td><?php echo e(__($c->order_by)); ?></td>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-md-12">
                                                                                <form action="<?php echo e(route('maincat_update')); ?>" method="POST" enctype="multipart/form-data"  runat="server">
                                                                                   ...
                                                                                   <input type="file" id="img" name="image" accept="image/*">
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <input type="text" name="caption" class="form-control" required value="<?php echo e(old('name', $c->caption)); ?>">
                                                                                        <?php if($errors->has('name')): ?>
                                                                                        <span class="text-danger" style="font-weight:bold"><?php echo e($errors->first('caption')); ?></span>
                                                                                        <?php endif; ?>
    ...
    <div class="modal fade" id="categoryModal" tabindex="-1" role="dialog" aria-labelledby="categoryModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="categoryModalLabel"><?php echo app('translator')->get('Add Main Category'); ?></h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="<?php echo e('maincat_store'); ?>" method="post" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
...
<div class="col-md-12">
								<div class="form-group">
									...
									<small class="text-primary"><?php echo app('translator')->get('Image will resize into 350x190 px'); ?></small>
								</div>
							</div>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u332918131/domains/zorokart.com/public_html/resources/views/admin/maincategory/maincategory.blade.php ENDPATH**/ ?>