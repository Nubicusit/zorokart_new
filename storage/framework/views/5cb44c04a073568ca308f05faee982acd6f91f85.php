    ...
    <div class="modal-content container school-edit-form">
            ...
            <section class="my-acc-home form-school">
                ...
                <div class="box-my-acc school-form-box">
                    <div class="container">
                    <form action="<?php echo e(route('institute_datastore')); ?>" method="post" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
<input type="hidden"  name="cat" value="<?php echo e($_GET['cat']); ?>">
                            <div class="row">
                                ...
                                <div class="col-md-6  ">
                                    ...
                                    <div class="profile-pic">
                                        ...
                                        <img alt="User Pic"
                                            src="<?php echo e(url('public/images/upload-pic.png')); ?>"
 ...
 <div class="col-md-6 left-sec">
                                        ...
                                        value="<?php echo e(old('address')); ?>" required></textarea>
                                        </div>
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-6 left-sec">
                                    ...
                                    <div class="row">
                                        ...
                                        <?php if(($_GET['cat']==="pc")||($_GET['cat']==="ug")): ?>
                                         <div class="col-md-6">
                                            <div class="form-group">
	...
	<div class="row">
        ...
        <div class="card mt-3 mb-3 pl-3 pr-3 py-3">
            ...
            &nbsp;<p style="color:black;">(Applicable only for approved institutions)</p></h4>
                ...
                <form action="<?php echo e(url('ins_search')); ?>" >
                <input type="hidden"  name="cat" value="<?php echo e($_GET['cat']); ?>">
                <div class="row">
                <div class="col-md-3">
         <select class="form-control" name="type">
            ...
            <div class="col-md-3"> <input type="text" class="form-control" value="<?php echo e($keyword); ?>" name="keyword" placeholder="Keyword"></div>
...
<input type="hidden" id="tabid" value="<?php echo e($k); ?>" name="tab">

			<div class="card">
				<div class="card-body p-5">
                <nav>
  <div class="nav nav-tabs" id="nav-tab" role="tablist">
    <a class="tab nav-item nav-link <?php echo e($a); ?>" data-val="1" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">New Registration</a>
    <a class="tab nav-item nav-link <?php echo e($b); ?>"  data-val="2" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">Approved</a>
    <a class="tab nav-item nav-link <?php echo e($c); ?>"  data-val="3"id="nav-contact-tab" data-toggle="tab" href="#nav-contact" role="tab" aria-controls="nav-contact" aria-selected="false">Rejected</a>
  </div>
  </form>
</nav>
<div class="tab-content" id="nav-tabContent">   <!-- 1st tab -->
  <div class="tab-pane fade show <?php echo e($a); ?>" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">	<div class="table-responsive">-
		              <table class="table">
		                  <thead>
		                    <tr>
                            <th scope="col"><?php echo app('translator')->get('ID'); ?></th>
                          
		                      <th scope="col"><?php echo app('translator')->get('Institution Name'); ?></th>
		                  ...
		                  <tbody class="cur-body">
		                  	<?php $__empty_1 = true; $__currentLoopData = $institute; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                 ...
                                 <td><?php echo e($loop->iteration); ?></td>
		                  			...
		                  			<td><?php echo e(__($i->name)); ?></td>
		                  		    <td style="white-space:initial"><?php echo e(__($i->city)); ?>,<?php echo e(__($i->state)); ?></td>
		                  		    <td> <?php echo e(date('d-m-y',strtotime($i->created_at))); ?></td>
		                  			<!--<td><?php echo e(__($i->ownership)); ?></td>-->
		                  			
		                  			<!--<?php if($i->photo=="" || $i->photo==0): ?>-->
		                  			<!--<td>      <img src="<?php echo e(('public/images/Artboard2.jpg')); ?>" height="250px" width="150px" style="height:150px;width:150px" alt="Image"></td>-->
		                  			<!--<?php else: ?>-->
		                  		 <!--<td><img src="<?php echo e(url('public/images').'/'.$i->photo); ?>" height="250px" width="150px" style="height:150px;width:150px"></td>-->
                       <!--               <?php endif; ?>-->
                                  
		                  			<td>
                                      <a href="<?php echo e(route('display_institution',$i->id)); ?>?cat=<?php echo e($_GET['cat']); ?>"  >
		                  			
                                      <i class="fa fa-eye"   style="font-size:20px; color:#32CD32;margin-right:5px" ></i>
                                          </a>  &nbsp;&nbsp;


		                  				<a href="<?php echo e(route('institution_edit',$i->id)); ?>?cat=<?php echo e($_GET['cat']); ?>" ><i class="fas fa-pencil-alt" 
                                                        style="font-size:20px; color: #000000;margin-right:5px"></i></a>
		                  				<i class="fa-solid fa-trash-can"></i>&nbsp;&nbsp;
		                  		<a href="<?php echo e(route('institution_destroy',$i->id)); ?>?cat=<?php echo e($_GET['cat']); ?>""   title="Delete the item" onclick="return confirm('Are you sure you want to delete this item?');">
		                  			
                                  <i class="fa fa-trash"     style="font-size:20px; color:#FF0000;margin-right:5px"></i>
		                  			</a>
                                      
                                          <!-- <a href="<?php echo e(route('institution_destroy',$i->id)); ?>" class="btn btn-danger btn-sm"  title="Delete the item" onclick="return confirm('Are you sure you want to delete this item?');">
  ...
  <div class="tab-pane fade show <?php echo e($b); ?>" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">	<div class="table-responsive">-
		              <table class="table" >
		                  <thead>
		                    <tr>
                            <th scope="col"><?php echo app('translator')->get('ID'); ?></th>
                            <th scope="col"><?php echo app('translator')->get('Premium membership'); ?></th>
		                      <th scope="col"><?php echo app('translator')->get('Institution Name'); ?></th>
		                      <th scope="col"><?php echo app('translator')->get('Address'); ?></th>
		                  ...
		                  <tbody class="cur-body">
                            ...
                            $k=0;
                            ?>
                          <?php $__empty_1 = true; $__currentLoopData = $instituteapp; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                          <?php
$k++;
                          ?>
		                  		<tr>
                                  <td><?php echo e($instituteapp->firstItem() + $loop->index); ?></td>
                                  <td>
                                    <?php if($i->premium==0): ?>
                                   
                                    <?php elseif($i->premium==1): ?>
                                    <!--<button class="btn-sm btn-success">Premium memberhh</button>-->
                                    <button type="button"  data-toggle="modal" data-target="#a<?php echo e($loop->iteration); ?>" class="btn-sm btn-success"><i class="feather icon-edit"></i>Premium member</button>
                                  
                                    
                                    <div class="modal fade" id="a<?php echo e($loop->iteration); ?>" role="dialog">
    <div class="modal-dialog">
    
      <!-- Modal content-->
      <div class="modal-content">
        <div class="modal-header">
        <h4 class="modal-title"><?php echo e(__($i->name)); ?></h4>
          <button type="button" class="close" data-dismiss="modal">&times;</button>
        
        </div>
        <div class="modal-body">
          
          <form action="<?php echo e(url('ins_premium_update')); ?>" method="get">
		<?php echo csrf_field(); ?>
		<label></label>
		<input type="hidden" value="<?php echo e($_GET['cat']); ?>" name="cat">
  ...
  <button type="button"  data-toggle="modal" data-target="#d<?php echo e($loop->iteration); ?>" class="btn btn-warning"><i class="feather icon-edit"></i>request</button>

  <!-- Modal -->
  <div class="modal fade" id="d<?php echo e($loop->iteration); ?>" role="dialog">
    <div class="modal-dialog">
...
<!--<?php endif; ?>-->
 ...
 <td> <?php echo e(date('d-m-y',strtotime($i->created_at))); ?></td>
                  ...
                  <!-- 3rd tab -->
  <div class="tab-pane fade  show <?php echo e($c); ?>" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">	<div class="table-responsive">-
		              <table class="table">
		                  <thead>
		                    <tr>
                            <th scope="col"><?php echo app('translator')->get('ID'); ?></th>
		                  ...
		                  <tbody class="cur-body">
                          <?php $__empty_1 = true; $__currentLoopData = $institutereg; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
		                  		<tr>
                                 <td><?php echo e($loop->iteration); ?></td>
		                  			<td><?php echo e(__($i->name)); ?></td>
		                  		    <td style="white-space:initial"><?php echo e(__($i->city)); ?>,<?php echo e(__($i->state)); ?></td>
...
<script>
  ...
  <script>
    ...
    <script src="<?php echo e(url('public/vendors/jquery.min.js')); ?>"></script>
    <script src="<?php echo e(url('public/vendors/popper/popper.js')); ?>"></script>
    <script src="<?php echo e(url('public/vendors/bootstrap/js/bootstrap.js')); ?>"></script>
    <script src="<?php echo e(url('public/vendors/hc-sticky/hc-sticky.js')); ?>"></script>
    <script src="<?php echo e(url('public/vendors/isotope/isotope.pkgd.js')); ?>"></script>
    <script src="<?php echo e(url('public/vendors/magnific-popup/jquery.magnific-popup.js')); ?>"></script>
    <script src="<?php echo e(url('public/vendors/slick/slick.js')); ?>"></script>
    <script src="<?php echo e(url('public/vendors/waypoints/jquery.waypoints.js')); ?>"></script>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u332918131/domains/zorokart.com/public_html/resources/views/admin/institution/index.blade.php ENDPATH**/ ?>