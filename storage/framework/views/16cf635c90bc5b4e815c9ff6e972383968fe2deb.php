...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="<?php echo e(url('public/images/favicon.png')); ?>">
    <script src="../cdn-cgi/apps/head/2oc_RD5SS6wgN5SiQnSEnWVNHg8.js"></script>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    <link rel="stylesheet" href="<?php echo e(url('public/vendors/font-awesome/css/fontawesome.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(url('public/vendors/magnific-popup/magnific-popup.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(url('public/vendors/slick/slick.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(url('public/vendors/animate.css')); ?>">

    <link rel="stylesheet" href="<?php echo e(url('public/css/style.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(url('public/css/resposive.css')); ?>">
                ...
                <div class="header-wrapper sticky-area">
                    ...
                    <div class="topbar d-flex institute-top">
                        <div class="topbar-item topbar-item-left d-flex align-items-center text-dark institute-top-1">
                            <div class="item">
                                <a class="navbar-brand navbar-brand-mobile inst-logo" href="<?php echo e(url('/')); ?>">
                                    <img src="<?php echo e(url('public/images/logo.png')); ?>" alt="schoolspe">
                                </a>
                            </div>
                        </div>
                                ...
                                <div class="header-customize-item">
                                    <a href="#" class="btn btn-primary register-btn" data-toggle="modal"
                                        data-target="#myModal-reg-inst">Register Institutions <img
                                            src="<?php echo e(url('public/images/reg-ic.png')); ?>"></a>
                                </div>
                            </div>
                            <div class="header-customize justify-content-end align-items-center d-none d-xl-flex ml-5">
                                ...
                                <div class="header-customize-item">
                                    <a href="#" class="btn btn-primary text-capitalize" data-toggle="modal"
                                        data-target="#myModal-log-inst"> Login <img src="<?php echo e(url('public/images/login.png')); ?>"> </a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-5 mb-6 mb-lg-0">
                            <div class="mb-2"><img src="<?php echo e(url('public/images/logo.png')); ?>" alt="Thedir"></div>
                            <div class="mb-2">
                            ...
                            <div class="region pt-1">
                                <div class="  d-flex"><img src="<?php echo e(url('public/images/foot-img.png')); ?>">
                                    <img src="<?php echo e(url('public/images/foot-img-2.png')); ?>" class="ml-3"></div>
                        ...
                        <div class="col-md-5 mb-6 mb-lg-0">
                            ...
                            <ul class="list-group list-group-flush list-group-borderless">
                                <li class="list-group-item px-0 lh-1625 bg-transparent py-1">
                                    <a href="tel:<?php echo e($settingsdata->phone); ?>" class="link-hover-secondary-primary text-dark"><img
                                            src="<?php echo e(url('public/images/call-calling.png')); ?>"><?php echo e($settingsdata->phone); ?> <?php echo e($settingsdata->phone1); ?> <?php echo e($settingsdata->phone2); ?></a>
                                </li>
                                <li class="list-group-item px-0 lh-1625 bg-transparent py-1">
                                    <a href="mailto:<?php echo e($settingsdata->email); ?>" class="link-hover-secondary-primary text-dark"><img
                                            src="<?php echo e(url('public/images/directbox-notif.png')); ?>"><?php echo e($settingsdata->email); ?></a>
                                </li>
                                <li class="list-group-item px-0 lh-1625 bg-transparent py-1">
                                    <a href="#" class="link-hover-secondary-primary text-dark"><img
                                            src="<?php echo e(url('public/images/route-square.png')); ?>">
                                        <?php echo e($settingsdata->address); ?></a>
                                </li>
                        ...
                        <div class="col-md-2  mb-6 mb-lg-0">
                          ...
                          <ul class="list-group list-group-flush list-group-borderless">
                            <li class="list-group-item px-0 lh-1625 bg-transparent py-1">
                                ...
                                <li class="list-group-item px-0 lh-1625 bg-transparent py-1">
                                    <a href="<?php echo e(url('about')); ?>" class="link-hover-secondary-primary">About us</a>
                                </li>
                                <li class="list-group-item px-0 lh-1625 bg-transparent py-1">
                    ...
                    <div class="footer-last-container position-relative">
                        <div class="row align-items-center">
                                    ...
                                    <ul class="list-inline">
                                        ...
                                        <li class="list-inline-item mr-5">
                                            <a target="_blank" title="Facebook" href="https://www.facebook.com/schoolspeofficial?mibextid=ZbWKwL">
                                                <img src="<?php echo e(url('public/images/ant-design_facebook-filled.png')); ?>">
                                            </a>
                                        </li>

                                        <li class="list-inline-item mr-5">
                                            <a target="_blank" title="Instagram" href="https://instagram.com/schoolspe_official?igshid=YmMyMTA2M2Y=">
                                                <img src="<?php echo e(url('public/images/ant-design_instagram-outlined.png')); ?>">
                                            </a>
                                        </li>
                                        <li class="list-inline-item mr-5">
                                            <a target="_blank" title="Twitter" href="https://www.linkedin.com/company/schoolspe-official/">
                                                <img src="<?php echo e(url('public/images/ant-design_twitter-outlined.png')); ?>">
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div class="col-lg-2 mb-3 mb-lg-0">
                                <div>
                                    <a href="<?php echo e(url('privacy_policy')); ?>" class="link-hover-dark-primary font-weight-semibold">Privacy
                                        & Policy</a>

                                </div>
                            </div>
                            <div class="back-top text-left text-lg-right gtf-back-to-top">
                                <a href="#" class="link-hover-secondary-primary"><img src="<?php echo e(url('public/images/arrow-top.png')); ?>"
...
<?php /**PATH /home/u332918131/domains/zorokart.com/public_html/resources/views/client/websitelayout2.blade.php ENDPATH**/ ?>