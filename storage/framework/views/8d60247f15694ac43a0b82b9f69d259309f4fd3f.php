...
<div class="contents">
    ...
    <div class="container-fluid">
        <div class="social-dash-wrap">
            ...
            <form action="<?php echo e(route('ins_profile_update')); ?>" method="post" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                <div class="card border-0 profile-admin">
                    <div class="profile-home"><img src="<?php echo e(url('public/img/images/Mask group.png')); ?>"></div>
                    <div class="profile-img">
                    <div class="avatar-upload">
        <div class="avatar-edit">
            <input type='file' id="imageUpload" name="image" accept=".png, .jpg, .jpeg" />
            <label for="imageUpload"><img src="<?php echo e(url('public/img/images/edit.png')); ?>" style="width:16px"></label>
        </div>
        <div class="avatar-preview profile-image">
            <?php if(auth()->user()->image): ?>
            <div  id="imagePreview" style="background-image: url('<?php echo e(url('public/images').'/'.auth()->user()->image); ?>');">
            <?php else: ?>
          ...
          <?php endif; ?>
                        ...
                        <!-- <img src="<?php echo e(url('public/img/images/Group 19.png')); ?>" class="profile-image"> -->
                        <div class="social-media">
                            <p>Share</p>
                            <a href="#"><img src="<?php echo e(url('public/img/images/Facebook.png')); ?>"></a>
                            <a href="#"><img src="<?php echo e(url('public/img/images/Instagram.png')); ?>"></a>
                            <a href="#"><img src="<?php echo e(url('public/img/images/Linkedin.png')); ?>"></a>
                            <a href="#"><img src="<?php echo e(url('public/img/images/Twitter.png')); ?>"></a>
                        </div>
                    </div>
                    ...
                    <div class="profile-detail-form">
                            ...
                            <div class="head-profile">
                                <h3>My Profile <a type="button" class="btn btn-default btn-edit js-edit"><img src="<?php echo e(url('public/img/images/edit.png')); ?>"></a></h3>
                                
                                <!--<a href="<?php echo e(url('edit_details_of_school')); ?>" class="btn btn-primary"><img src="<?php echo e(url('public/img/images/edit-btn.png')); ?>">&nbsp; Edit Institute-->
                                <!--    Details</a>-->
                            ...
                            <div class="form-group">
                               ...
                               <?php if(1): ?>
                                ...
                                <a class="nav-btn btn btn-primary opt" 
                                 data-link="<?php echo e(url('get_premium')); ?>" id="premium" style="color: white;"  > 
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
           <form method="post" action="<?php echo e(url('admission_date_update')); ?>">
                                                  <?php echo csrf_field(); ?>
                                ...
                                <div class="row form-row">
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control is-disabled" placeholder="Name" name="name"  value="<?php echo e(auth()->user()->user_name); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control is-disabled" placeholder="Email"  name="email" value="<?php echo e(auth()->user()->email); ?>" >
                                        </div>
                                    </div>
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            <label>Mobile Number</label>
                                            <input type="text" class="form-control is-disabled" placeholder="phone"  name="phone"value="<?php echo e(auth()->user()->user_phone); ?>" >
                                        </div>
                                    </div>
                                    <div class="col-md-2"></div>
...
<?php echo $__env->make('institute.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u332918131/domains/zorokart.com/public_html/resources/views/institute/profile1.blade.php ENDPATH**/ ?>