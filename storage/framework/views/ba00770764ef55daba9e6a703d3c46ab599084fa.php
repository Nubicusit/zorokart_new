  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?php echo e(url('ins_change_password')); ?>" method="post" onSubmit = "return checkPassword(this)">
            <?php echo csrf_field(); ?>
...
<header class="header-top">
        <nav class="navbar navbar-light">
            <div class="navbar-left">
                <a href="" class="sidebar-toggle">
                    <img class="svg" src="<?php echo e(url('public/img/svg/bars.svg')); ?>" alt="img"></a>
                    <?php
                     $logo=$settings->logo;
                    ?>
                <a class="navbar-brand" href="#"><img class="dark" src="<?php echo e(url('public/images/logo/'.$logo)); ?>" alt="svg"></a>
            </div>
                ...
                <ul class="navbar-right__menu">
                    ...
                    <li class="nav-message">
                        <div class="dropdown-custom">
                            <!--<a  href="<?php echo e(url('ins_msg')); ?>?id=" class="nav-item-toggle">-->
                    ...
                    <li class="nav-author">
                        <div class="dropdown-custom">
                            <a href="javascript:;" class="nav-item-toggle"><img src="<?php echo e(url('public/img/author-nav.jpg')); ?>" alt=""
                            ...
                            <div class="dropdown-wrapper">
                                ...
                                <div class="nav-author__options">
                                    <ul>
                                        ...
                                        <li>
                                            <a href="<?php echo e(url('change-password')); ?>" data-toggle="modal" data-target="#exampleModal">
                                         ...
                                         <li>
                                            <a href="<?php echo e(url('ins_delete')); ?>">
                                                <span data-feather="trash-2"></span>Delete Account</a>
                                        </li>
                                        
                                        
                                        <li>
                                            <a href="<?php echo e(url('institution_logout')); ?>">
   ...
   <?php /**PATH /home/u332918131/domains/zorokart.com/public_html/resources/views/institute/include/topbar.blade.php ENDPATH**/ ?>