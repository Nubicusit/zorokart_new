...
<?php echo \Illuminate\View\Factory::parentPlaceholder('headerscript'); ?>
...
<script>
swal("", "<?php echo Session::get('success'); ?>", )
    .then(function() {
        // window.location.href = "<?php echo e(route('institute')); ?>";
    })
</script>
<?php endif; ?>
...
<div class="content mt-5 pt-5 animation-section">
    ...
    <section id="section-02" class="pb-10 feature-destination pt-85  institute-revolution desktop-isti">
        <div class="container">
            ...
            <div class="left-text-we-inner  test-institute-4"><img src="<?php echo e(url('public/images/institute-1.png')); ?>">
            ...
            <div class="left-text-we-inner  test-institute-4 mobile-section">
                <div class="button-sec" data-animate="zoomIn">
                    <div class="button-sec-btn-1 row">
                        <div class="col-md-3">
                            <img src="<?php echo e(url('public/images/inst-1.png')); ?>">
                        </div>
                        <div class="col-md-9">
                           <h4>Explore the Unexplored </h4>
                        <p><span> SchoolsPe </span> will help you explore the unexplored markets.We offer cross territorial
approach and critical insights to step into new markets.</p>
                    ...
                    <div class="button-sec-btn-1 row" data-animate="zoomIn">
                        <div class="col-md-3">
                            <img src="<?php echo e(url('public/images/inst-2.png')); ?>">
                        </div>
                        <div class="col-md-9">
                           <h4>Prospect Nurturing</h4>
                        <p>
...
admission will be taken care by the expert counselling team at SchoolsPe.</p>
                    ...
                    <div class="button-sec-btn-1 row" data-animate="zoomIn">
                        <div class="col-md-3">
                            <img src="<?php echo e(url('public/images/inst-3.png')); ?>">
                        </div>
                        <div class="col-md-9">
 <h4>Know your Market</h4>
                        <p>
...
Which indeed helps you to improve overall as an institution.</p>
                    ...
                    <div class="button-sec-btn-1 row" data-animate="zoomIn">
                        <div class="col-md-3">
                            <img src="<?php echo e(url('public/images/inst-4.png')); ?>">
                        </div>
                        <div class="col-md-9">
                            <h4>Attract with Ease</h4>
                        <p>
...
clicks and experience it deliver to parent-student within minutes.
                    ...
                    <div class="button-sec-btn-1 row" data-animate="zoomIn">
                        <div class="col-md-3">
                            <img src="<?php echo e(url('public/images/inst-5.png')); ?>">
                        </div>
                        <div class="col-md-9">
                            <h4>Adopt and Grow</h4>
                        <p>
...
passion towards providing quality education.</p>
                    ...
                    <div class="button-sec-btn-1 row" data-animate="zoomIn">
                        <div class="col-md-3">
                            <img src="<?php echo e(url('public/images/inst-6.png')); ?>">
                        </div>
                        <div class="col-md-9">
                           <h4>Performance at your finger tips</h4>
                        <p>
        ...
        <div class="container">
            ...
            <div class="items review" id="contact-inst">>
                <div class="box " data-animate="zoomIn">
                    <div class="card  border-0">
                        <div class="pro-img pulse">
                            ...
                            <img src="<?php echo e(url('public/images/inst-ic.png')); ?>">
                        </div>
                ...
                <div class="box " data-animate="zoomIn">
                    <div class="card  border-0">
                        <div class="pro-img pulse">
                            <img src="<?php echo e(url('public/images/inst-ic-1.png')); ?>" style="width:95px">
                        </div>
                ...
                <div class="box card-container__card" data-animate="zoomIn">
                    <div class="card border-0">
                        <div class="pro-img pulse">
                            <img src="<?php echo e(url('public/images/inst-ic-2.png')); ?>" style="width:65px">
                        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 left-reg-sec" data-animate="fadeInLeft">
                    <img src="<?php echo e(url('public/images/Logo-1.png')); ?>">
                ...
                <div class="col-md-5 centered" data-animate="fadeInRight">
                     <form action="<?php echo e('contactus_store'); ?>" method="post" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                            ...
                            <div role="tabpanel" class="tab-pane active text-center" id="home">
                                <div class="row">
                                    ...
                                    <div class="col-md-7 right-side-log">
                                        <img src="<?php echo e(url('public/images/logo.png')); ?>" class="logo">
                                        ...
                                        <div id="mainWrap">
                                            <div id="xlogin">
                                                ...
                                                <form action="<?php echo e(url('ins_login')); ?>" id="logForm" method="post"
                                    ...
                                    <div class="col-md-7 right-side-log">
                                        ...
                                        <div id="mainWrap">
                                            <div id="xlogin">
                                                ...
                                                <form method="POST" action="<?php echo e(route('parent_registration')); ?>">
                                                    <?php echo csrf_field(); ?>
...
select.inst-select:invalid {
    ...
    <?php echo \Illuminate\View\Factory::parentPlaceholder('footerscript'); ?>
    <?php $__env->stopSection(); ?>

<?php echo $__env->make('client.websitelayout2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u332918131/domains/zorokart.com/public_html/resources/views/client/institute.blade.php ENDPATH**/ ?>