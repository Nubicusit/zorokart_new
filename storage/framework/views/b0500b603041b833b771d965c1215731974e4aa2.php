...
<body>
  <div class="container d-flex justify-content-center align-items-center vh-100">
    <div class="row w-75 shadow-lg">
      ...
      <div class="col-md-6 left-section text-center">
        ...
        <a class="btn d-dlock mt-3">Already have an account? <a href="<?php echo e(url('signin')); ?>" style="color:#fff"><b class="signinclass">Sign in.</b></a>
      </div>
      <!-- Right Section -->
  ...
  <?php endif; ?>
        ...
        <form action="<?php echo e('custom-registration'); ?>" method="post">
          <?php echo csrf_field(); ?>
          <div class="mb-4">
          ...
          <button type="submit" class="btn btn-dark w-100 signup-btn">Signup</button>
        </form>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u332918131/domains/zorokart.com/public_html/resources/views/home/user_signup.blade.php ENDPATH**/ ?>