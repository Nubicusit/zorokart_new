...
<link href="<?php echo e(asset('assets/admin/plugins/jquery-smartwizard/smart_wizard_all.min.css')); ?>" rel="stylesheet" type="text/css" />
<?php $__env->stopPush(); ?>
...
<div class="content-wrapper">
    <section class="content">
        ...
        <div class="col-xl-12 mb-30 mb-xl-0">
                    ...
                    <div id="smartwizard">
                        ...
                        <div class="tab-content">
                            <div id="step-1" class="tab-pane" role="tabpanel">
                                <!-- Basic Details -->
                               <?php echo $__env->make('admin.products._create._details', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                <!-- End User Details -->
                            </div>
                            <div id="step-2" class="tab-pane" role="tabpanel">
                                <!-- Address-->
                                <?php echo $__env->make('admin.products._create._specifications', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>   
                            
                                <!-- End Address -->
                            </div>
                            <div id="step-3" class="tab-pane" role="tabpanel">
                                <!-- Address-->
                                <?php echo $__env->make('admin.products._create._gallery', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>  
            ...
            <script src="<?php echo e(asset('assets/admin/plugins/jquery-smartwizard/jquery.smartWizard.min.js')); ?>"></script>
            <?php echo $__env->make('admin.products.js.customSmartWizard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <script>
             $(document).ready(function() {
                $('#spec-add').on('click', function(e) { //on file input change
                    ...
                    $.ajax({
                        type: 'POST',
                        url: "<?php echo e(route('products.specifications')); ?>",
                        data: formData,
                        dataType: 'JSON',
                        contentType: false,
                        cache: false,
                ...
                jQuery(document).delegate('a.del-sprow', 'click', function(e) {
                    ...
                    $.ajax({
                        url:"<?php echo e(route('specification.delete', ':rid')); ?>".replace(':rid', rid),
                        type: 'DELETE',
                        data: {
                            "id": rid,
                            "_token": token,
    ...
    <?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u332918131/domains/zorokart.com/public_html/resources/views/admin/products/create.blade.php ENDPATH**/ ?>