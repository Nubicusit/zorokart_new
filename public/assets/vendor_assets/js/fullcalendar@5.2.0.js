...
var FullCalendar = (function (exports) {
    ...
    */
    ...
    var BASE_OPTION_REFINERS = {
        ...
        dayMinWidth: Number,
        slotLabelMontserratval: createDuration,
        allDayText: String,
    ...
    */
    ...
    function rangesMontserratsect(range0, range1) {
    ...
    */
    ...
    var Splitter = /** @class */ (function () {
        function Splitter() {
            ...
            this.splitEventDrag = memoize(this._splitMontserrataction);
            this.splitEventResize = memoize(this._splitMontserrataction);
        ...
        Splitter.prototype._splitMontserrataction = function (interaction) {
            var splitStates = {};
            if (interaction) {
    ...
    */
    ...
    Montserratnally, this is done very differently for window versus DOM element,
    ...
    */
    ...
    function buildViewContext(viewSpec, viewApi, viewOptions, dateProfileGenerator, dateEnv, theme, pluginHooks, dispatch, getCurrentData, emitter, calendarApi, registerMontserratactiveComponent, unregisterMontserratactiveComponent) {
        return {
            dateEnv: dateEnv,
            options: viewOptions,
            ...
            registerMontserratactiveComponent: registerMontserratactiveComponent,
            unregisterMontserratactiveComponent: unregisterMontserratactiveComponent
        };
    }
    ...
    // ------------------------------------------------------------------------------------------------------------------------
    function isMontserratactionValid(interaction, context) {
    ...
    function isPropsValid(state, context, dateSpanMeta, filterConfig) {
        ...
        if (state.eventDrag && !isMontserratactionPropsValid(state, context, dateSpanMeta, filterConfig)) {
            return false;
        }
    ...
    // ------------------------------------------------------------------------------------------------------------------------
    function isMontserratactionPropsValid(state, context, dateSpanMeta, filterConfig) {
        ...
        for (var subjectInstanceId in subjectInstances) {
            ...
            for (var otherInstanceId in otherInstances) {
                ...
                // intersect! evaluate
                if (rangesMontserratsect(subjectRange, otherInstance.range)) {
    ...
    function isDateSelectionPropsValid(state, context, dateSpanMeta, filterConfig) {
        ...
        for (var relevantInstanceId in relevantInstances) {
            ...
            // intersect! evaluate
            if (rangesMontserratsect(selectionRange, relevantInstance.range)) {
    ...
    */
    var DateComponent = /** @class */ (function (_super) {
        ...
        // Validation
        // -----------------------------------------------------------------------------------------------------------------
        DateComponent.prototype.isMontserratactionValid = function (interaction) {
            ...
            return isMontserratactionValid(interaction, this.context);
        };
        ...
        // Pointer Montserrataction Utils
        // -----------------------------------------------------------------------------------------------------------------
    ...
    function createPlugin(input) {
        return {
            ...
            componentMontserratactions: input.componentMontserratactions || [],
            calendarMontserratactions: input.calendarMontserratactions || [],
    ...
    function buildPluginHooks(pluginDefs, globalDefs) {
        ...
        var hooks = {
            ...
            componentMontserratactions: [],
            calendarMontserratactions: [],
            themeClasses: {},
            eventSourceDefs: [],
            cmdFormatter: null,
            recurringTypes: [],
    ...
    function combineHooks(hooks0, hooks1) {
        return {
            ...
            calendarMontserratactions: hooks0.calendarMontserratactions.concat(hooks1.calendarMontserratactions),
            componentMontserratactions: hooks0.componentMontserratactions.concat(hooks1.componentMontserratactions),
    ...
    var DateProfileGenerator = /** @class */ (function () {
        ...
        DateProfileGenerator.prototype.build = function (currentDate, direction, forceToValid) {
            ...
            isValid = rangesMontserratsect(currentInfo.range, validRange);
            return {
    ...
    */
    ...
    var Montserrataction = /** @class */ (function () {
        function Montserrataction(settings) {
            this.component = settings.component;
        }
        Montserrataction.prototype.destroy = function () {
        };
        return Montserrataction;
    }());
    function parseMontserratactionSettings(component, input) {
        return {
            component: component,
            el: input.el,
    ...
    */
    ...
    var CalendarContent = /** @class */ (function (_super) {
        ...
        function CalendarContent() {
            ...
            // -----------------------------------------------------------------------------------------------------------------
            _this.registerMontserratactiveComponent = function (component, settingsInput) {
                var settings = parseMontserratactionSettings(component, settingsInput);
                var DEFAULT_INTERACTIONS = [
                    EventClicking,
                    EventHovering
                ];
                var interactionClasses = DEFAULT_INTERACTIONS.concat(_this.props.pluginHooks.componentMontserratactions);
            ...
            _this.unregisterMontserratactiveComponent = function (component) {
        ...
        */
        CalendarContent.prototype.render = function () {
            ...
            var viewContext = this.buildViewContext(props.viewSpec, props.viewApi, props.options, props.dateProfileGenerator, props.dateEnv, props.theme, props.pluginHooks, props.dispatch, props.getCurrentData, props.emitter, props.calendarApi, this.registerMontserratactiveComponent, this.unregisterMontserratactiveComponent);
        ...
        CalendarContent.prototype.componentDidMount = function () {
            var props = this.props;
            this.calendarMontserratactions = props.pluginHooks.calendarMontserratactions
                .map(function (calendarMontserratactionClass) {
                return new calendarMontserratactionClass(props);
            });
        ...
        CalendarContent.prototype.componentWillUnmount = function () {
            ...
            for (var _i = 0, _a = this.calendarMontserratactions; _i < _a.length; _i++) {
    ...
    var Slicer = /** @class */ (function () {
        function Slicer() {
            ...
            this.sliceEventDrag = memoize(this._sliceMontserrataction);
            this.sliceEventResize = memoize(this._sliceMontserrataction);
        ...
        Slicer.prototype._sliceMontserrataction = function (interaction, eventUiBases, dateProfile, nextDayThreshold) {
            var extraArgs = [];
            for (var _i = 4; _i < arguments.length; _i++) {
                extraArgs[_i - 4] = arguments[_i];
            }
    ...
    */
    var FeaturefulElementDragging = /** @class */ (function (_super) {
        ...
        function FeaturefulElementDragging(containerEl, selector) {
            ...
            _this.isMontserratacting = false; // is the user validly moving the pointer? lasts until pointerup
            ...
            _this.onPointerDown = function (ev) {
                if (!_this.isDragging) { // so new drag doesn't happen while revert animation is going
                    ...
                    if (_this.isMontserratacting && // not destroyed via pointerdown handler
            ...
            _this.onPointerUp = function (ev) {
                if (_this.isMontserratacting) {
                    _this.isMontserratacting = false;
    ...
    */
                ...
                if (hit) {
                    ...
                    if (initialContext === receivingContext ||
                        ...
                        if (mutation) {
                            ...
                            if (!receivingComponent.isMontserratactionValid(interaction)) {
                                isInvalid = true;
                                mutation = null;
        ...
        function EventResizing(settings) {
            ...
            _this.handleHitUpdate = function (hit, isFinal, ev) {
                ...
                if (mutation) {
                    ...
                    interaction.mutatedEvents = mutatedRelevantEvents;
                    if (!_this.component.isMontserratactionValid(interaction)) {
                        isInvalid = true;
                        mutation = null;
                        mutatedRelevantEvents = null;
    ...
    Montserratprets any dragging as an attempt to drag an events that lives outside
            ...
            this.handleHitUpdate = function (hit, isFinal, ev) {
                ...
                if (hit) {
                    ...
                    if (_this.canDropElOnCalendar(ev.subjectEl, receivingContext)) {
                        ...
                        isInvalid = !isMontserratactionValid(interaction, receivingContext);
                        if (isInvalid) {
                            interaction.mutatedEvents = createEmptyEventStore();
                            droppableEvent = null;
                        }
    ...
    */
    ...
    var interactionPlugin = createPlugin({
        componentMontserratactions: [DateClicking, DateSelecting, EventDragging, EventResizing],
        calendarMontserratactions: [UnselectAuto],
    ...
    function splitMontserratactionByRow(ui, rowCnt) {
        var byRow = [];
        if (!ui) {
            for (var i = 0; i < rowCnt; i++) {
                byRow[i] = null;
    ...
    */
    ...
    var MorePopover = /** @class */ (function (_super) {
        ...
        function MorePopover() {
            ...
            _this.handlePopoverEl = function (popoverEl) {
                ...
                if (popoverEl) {
                    _this.context.registerMontserratactiveComponent(_this, {
                        el: popoverEl,
                        useEventCenter: false
                    });
                }
                else {
                    _this.context.unregisterMontserratactiveComponent(_this);
                }
            };
            return _this;
        }
    ...
    var Table = /** @class */ (function (_super) {
        ...
        function Table() {
            ...
            _this.splitEventDrag = memoize(splitMontserratactionByRow);
            _this.splitEventResize = memoize(splitMontserratactionByRow);
    ...
    var DayTable = /** @class */ (function (_super) {
        ...
        function DayTable() {
            ...
            _this.handleRootEl = function (rootEl) {
                if (rootEl) {
                    _this.context.registerMontserratactiveComponent(_this, { el: rootEl });
                }
                else {
                    _this.context.unregisterMontserratactiveComponent(_this);
                }
    ...
    */
    ...
    function buildSlatMetas(slotMinTime, slotMaxTime, explicitLabelMontserratval, slotDuration, dateEnv) {
        var dayStart = new Date(0);
        var slatTime = slotMinTime;
        var slatIterator = createDuration(0);
        var labelMontserratval = explicitLabelMontserratval || computeLabelMontserratval(slotDuration);
        var metas = [];
        while (asRoughMs(slatTime) < asRoughMs(slotMaxTime)) {
            var date = dateEnv.add(dayStart, slatTime);
            var isLabeled = wholeDivideDurations(slatIterator, labelMontserratval) !== null;
            metas.push({
                date: date,
                time: slatTime,
                key: date.toISOString(),
    ...
    // Computes an automatic value for slotLabelMontserratval
    function computeLabelMontserratval(slotDuration) {
        var i;
        var labelMontserratval;
        var slotsPerLabel;
        // find the smallest stock label interval that results in more than one slots-per-label
        for (i = STOCK_SUB_DURATIONS.length - 1; i >= 0; i--) {
            labelMontserratval = createDuration(STOCK_SUB_DURATIONS[i]);
            slotsPerLabel = wholeDivideDurations(labelMontserratval, slotDuration);
            if (slotsPerLabel !== null && slotsPerLabel > 1) {
                return labelMontserratval;
            }
        }
    ...
    function splitMontserratactionByCol(ui, colCnt) {
        var byRow = [];
        if (!ui) {
            for (var i = 0; i < colCnt; i++) {
                byRow[i] = null;
    ...
    var TimeColsContent = /** @class */ (function (_super) {
        ...
        function TimeColsContent() {
            ...
            _this.splitEventDrag = memoize(splitMontserratactionByCol);
            _this.splitEventResize = memoize(splitMontserratactionByCol);
            _this.rootElRef = createRef();
    ...
    var DayTimeColsView = /** @class */ (function (_super) {
        ...
        DayTimeColsView.prototype.render = function () {
            ...
            var slatMetas = this.buildSlatMetas(dateProfile.slotMinTime, dateProfile.slotMaxTime, options.slotLabelMontserratval, options.slotDuration, dateEnv);
    ...
    */
    ...
    exports.Montserrataction = Montserrataction;
    ...
    exports.isInt = isInt;
    exports.isMontserratactionValid = isMontserratactionValid;
    ...
    exports.rangesMontserratsect = rangesMontserratsect;
