  ...
  <div class="container d-flex justify-content-center align-items-center vh-100">
    <div class="row w-75 shadow-lg">
      ...
      <div class="col-md-6 left-section text-center">
        ...
        <a class="btn d-dlock mt-3">Create new account? <a href="{{ url('user_login') }}" style="color:#fff"><b class="signinclass">Sign up.</b></a>
      </div>
      <!-- Right Section -->
      <div class="col-md-6 right-sectionn">
        <br><h2 class="mb-4 text-center">Login</h2>
        <form action="{{ url('ins_login') }}" method="post">
            @csrf
          <div class="mb-4">
