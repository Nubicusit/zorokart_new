                        ...
                        <form action="{{route('application_store')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class=" profile-form">
                                    <img src="{{url('public/images/apptemp/'.$data->photo)}}">
                                </div>
                            </div>
...
<hr><br>
 ...
 <h4 > Address Details</h4>
                            ...
                            <div class="row  third-row">
                                <div class="col-md-4">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="address_same" checked readonly>
                            ...
                            <div class="row  third-row">
                                <div class="col-md-12">
                                    <div class="form-check form-check-inline">
                                        ...
                                        <label class="form-check-label" style="color: #000 !important;">Note:
                                        The details can't be changed once you submit the application form.</label>
                                    </div>


                                </div>
                            </div>
<input type="hidden" class="form-control" placeholder="" value="{{$app_id}}" name="app_id">
                            <div class="btn-save-sec">
                                <a  href="{{url('application_edit/'.$app_id)}}" class="btn  btn-save">Back</a>
                                <button type="submit" class="btn btn-sb">Confirm</button></div>
