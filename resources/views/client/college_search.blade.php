                                ...
                                <div class="row">
                                    <div class="fliter-sec-school">
                                        ...
                                        <div class="filter-menu">
                                            <form action="{{url('college_search_result')}}" method="get">
                                                @csrf
                  ...
                  <div class="page-content col-12 col-lg-9">
                            ...
                            <div class="explore-filter d-lg-flex  d-block">
                                <div>
                                    <ul class="breadcrumb breadcrumb-style-02 school ">
                                        ...
                                        <li class="breadcrumb-item">Colleges in Bangalore</li>
                                    </ul>
                                    <h3 class="head-student">Colleges in Bangalore</h3>
							...
							for($i=0;$i<$gallery_count;$i++)
							{
							    ?>
                                    ...
                                    <a href="{{url('college_single',$s->id)}}">
                                        ...
                                        <div class="media-body  px-md-4   col-md-9">
                                            ...
                                            <div class="d-flex lh-1  store-name-2">
                                                ...
                                                <div>
                                                    ...
                                                    <a href="{{'school_apply_form'}}" class="btn btn-sb">Apply Now</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
