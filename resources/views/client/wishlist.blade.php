...
@section('content')
        ...
        <div class="content animation-section">
            ...
            <section class="my-acc-home">
                <div class="container">
                    <h3 class="text-dbs">Welcome {{Auth::guard('parent')->user()->name}}</h3>
                    <p>Shortlisted Schools</p>


                </div>

            </section>
            <section class="short-list-sec">
                <div class="container">
                    <div class="short-sec">
                        <h6 class="mb-3">{{$result_count}} Shortlisted Schools</h6>
                                ...
                                <div class="mb-6">
                                    ...
                                    <div class="store media align-items-stretch bg-white job-store row">
                                        ...
                                        @if($gallery_count>=1)
                                            <div>
                                                <a href="{{route('school_single') }}?{{$s->id}}">
                                                ...
                                                $current_date=date('Y-m-d');
                                                 ...
                                                 if (strtotime($current_date) < strtotime($s->end_date)) 
{
$admission=1;
?>
...
<?php
                                        ...
                                        @endif
 <span><a href="{{ route('remove_wishlist',$s->id1) }}"  class="favourite ml-auto  heart "><i class="fa fa-trash" aria-hidden="true"></i></a></span>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control" rows="4"
                                    placeholder="Please type your requirenments" name="message"></textarea>
                            </div>
                        </div>
                        <div class="bottom-btn-md">
                            <a href="#" class="cancel btn mt-5" data-dismiss="modal">Cancel</a>
                            <button type="submit" class="btn btn-sb mt-5">Send messge</button></div>
                    </form>
                </div>
