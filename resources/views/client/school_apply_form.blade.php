...
@section('content')
        ...
        <form action="{{route('application_preview')}}" method="post" enctype="multipart/form-data">
                    @csrf
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Name of the Student <span>*</span>
                                        </label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Student Email ID<span>*</span></label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" 
                                                id="inlineRadio1" value="option1" name="gender" required>
                                            <img src="{{url('public/images/male.png')}}">
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" 
                                                id="inlineRadio2" value="option2" name="gender" required>
                            ...
                            <div class="row  third-row">
                                 <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        @if($data->type=="s")
                                        <label>Admission into (class/course)<span>*</span></label>
                                        @else
                                         <label>Admission into (class/course)<span>*</span></label>
                                        @endif
                                           <input type="text" class="form-control" placeholder="" name="s_class" required>
                             ...
                             <div class="row  third-row">
                                    <div class="col-md-6">
                                    <label>Caste</label>
                                    <input type="text" class="form-control" placeholder="" name="cast" >
                                </div> 
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="" name="adhaar" >
...
<hr><br>
 <h4 >Parent Details</h4>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Father’s Name <span>*</span>
                                        </label>
                                        <input type="text" class="form-control" placeholder="" name="f_name" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" placeholder="" name="f_phone" id="mob_no_fathet" required >
                            ...
                            <div class="row  third-row">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" placeholder="" name="f_qualification" >
                                    
                               </div>

                                <div class="col-md-4">
                                    <label>Occupation</label>
                                    <input type="text" class="form-control" placeholder="" name="f_occupation" >
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="" name="f_income" >
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Mother’s Name <span>*</span>
                                        </label>
                                        <input type="text" class="form-control" placeholder="" name="m_name" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" placeholder="" name="m_phone" id="mob_no_mother" >
                            ...
                            <div class="row  third-row">
                                <div class="col-md-4">
                                    <label>Qualification</label>
                                    <input type="text" class="form-control" placeholder="" name="m_qualification" >
                                    

                                </div>
                                <div class="col-md-4">
                                    <label>Occupation</label>
                                    <input type="text" class="form-control" placeholder="" name="m_occupation" >
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Annual Income</label>
                                        <input type="text" class="form-control" placeholder="" name="m_income" >
...
<hr><br>
 <h4 >Address Details</h4>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Permanent Address<span>*</span>
                                        </label>
                                        <textarea class="form-control" rows="2" id="per-1" name="address" required></textarea>
                            ...
                            <div class="row  third-row">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" placeholder="" name="district"  id="per-2" required>
                                

                                </div>
                                <div class="col-md-4">
                                    <label>State<span>*</span></label>
                                    <input type="text" class="form-control" placeholder="" name="state" id="per-3" required>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" placeholder="" id="per-4" name="pincode" required>
                            ...
                            <div class="row  third-row">
                                <div class="col-md-4">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="address_same" name="permanent_add">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Correspondence Address<span>*</span>
                                        </label>
                                        <textarea class="form-control" rows="2" id="cor-1" name="cor_address" required></textarea>
                            ...
                            <div class="row  third-row">
                                <div class="col-md-4">
                                    <label>District<span>*</span></label>
                                    <input type="text" class="form-control" placeholder=""  id="cor-2" name="cor_district" required>
                                    

                                </div>
                                <div class="col-md-4">
                                    <label>State<span>*</span></label>
                                    <input type="text" class="form-control" placeholder="" id="cor-3" name="cor_state" required>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>PIN Code<span>*</span></label>
                                        <input type="number" class="form-control" placeholder="" id="cor-4" name="cor_pincode" required>
                            ...
                            <div class="btn-save-sec">
                                <button  class="btn btn-sb sign-up-btn" type="submit">Submit</button></div>
                        </form>
