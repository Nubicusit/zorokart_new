...
@endif
                        <form action="{{url('parent_first_update')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Full Name</label>
                                        <input type="text" class="form-control" name="name" placeholder="Enter name" value="{{Auth::guard('parent')->user()->name}}" required>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" name="email" placeholder="Enter email"
                                            value="{{Auth::guard('parent')->user()->email}}"required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="phone" class="form-control" value="{{Auth::guard('parent')->user()->phone}}"required>
                                    </div>
                                </div>
                            ...
                            <div class="btn-save-sec">
                                <button type="submit"  class="btn btn-save">Save Changes</a></div>
                        </form>
                    ...
                    <div class="my-acc-bottom my-acc-bottom-form">
                        <h4>Tell us about yourself</h4>
                        <p>This will help us perosnalize your experience</p>
                        <div class="row">

                            <form action="{{ route('parentdata_store') }}" method="post" enctype="multipart/form-data" >
                @csrf
                <div class="row">
    ...
    <!--<img id="profilePic" class="pic" src="https://source.unsplash.com/random/150x150?person">-->
     ...
     @if(auth::guard('parent')->user()->image)
                                    ...
                                    ?>
                                     <!--<img src="{{url('public/images/parant/'.$img)}}" alt="schoolspe" class="pic" id="profilePic">-->
                                     @else
                                      <!--<img src="{{url('public/images/young-user-icon 1.png')}}" alt="schoolspe" class="pic" id="profilePic">-->
                                    @endif
...
@endif
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            ?>
                                            @endif
                                            <input type="text" class="form-control" placeholder=""value="{{$mname}}" name="mname" required>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            ?>
                                            @endif
                                            <input type="text" class="form-control" placeholder="" value="{{$address}}"name="address" required>
                                        </div>
                                     ...
                                     <div class="col-md-4">
                                      <div class="form-group">
                                            ...
                                            ?>
                                            @endif
                                           <input type="text" name="city"class="form-control" value="{{$city}}"placeholder="" required>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                            ...
                                            ?>
                                            @endif
                                            <input type="text" name="state"class="form-control"value="{{$state}}" placeholder="" required>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            ?>
                                            @endif
                                            <input type="text" class="form-control" placeholder=""value="{{$pincode}}" name="pincode" required>
                        ...
                        <div class="btn-save-sec-1">
                            <!--<a href="#" class="btn btn-save">Save Changes</a></div>-->
                            <input  type="submit"  class="btn btn-save" value="Save Changes"></input>
                        </form>
