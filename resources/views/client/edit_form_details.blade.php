        ...
        <div class="content animation-section">
             <section class="my-acc-home form-school">
                <div class="container">
                    ...
                    <p>Please fill these details very carefully. </p>
                </div>

            </section>
            <section class="my-acc-home-inner ">
                <div class="container">
                    <div class="box-my-acc school-form-box  filled-form mt-5 pt-5">

                        <form action="{{route('update_application')}}" method="post" enctype="multipart/form-data">
                            @csrf
         ...
         <div class="row">
                                <div class="small-12 large-4 columns">
                                    ...
                                    <div class="conta-set">
                                        ...
                                        <div class="imageWrapper">
                                            @if($data->photo)
                                             <img class="image" src="{{url('public/images/apptemp/'.$data->photo)}}">
                                            @else
                                            <img class="image" src="{{url('public/images/apptemp/upload-pic.png')}}">
                                            @endif
                                        </div>
                                    </div>

                                    <button class="file-upload">
                                        <input type="file" class="file-input" name="photo">Upload Photo
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" placeholder="" name="dob"  value="{{ $data->dob }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="gender"
                                                id="inlineRadio1" value="option1"  <?php $checked = "";
                                         ...
                                         <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio"
                                                id="inlineRadio2" value="option2" name="gender"   <?php $checked = "";
                                                                                                                    if ($data->gender == 'option2') {
                                                                                                                        $checked = "checked";
                                                                                                                    } ?>size="17" <?= $checked; ?>>
                            ...
                            <div class="row  third-row">
                                 <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Admission into (class/course)</label>
                                      <input type="text" class="form-control" placeholder="" name="s_class"  value="{{ $data->s_class }}">
                                ...
                                <div class="col-md-6">
                                  ...
                                  <input type="text" class="form-control" placeholder="" name="religion" value="{{ $data->religion }}">

                                </div>

                            </div>
  <div class="row  third-row">   <div class="col-md-6">
                                    <label>Caste</label>
                                   <input type="text" class="form-control" placeholder="" name="cast"  value="{{ $data->cast }}">
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Category</label>
                                            <input type="text" class="form-control" placeholder="" name="category"  value="{{ $data->category }}">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Student (Adhar card) No.
                                         ...
                                         <input type="text" class="form-control" placeholder="" name="adhaar" value="{{ $data->adhaar }}">
...
<hr><br>
 <h4 >Parent Details</h4>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Father’s Name
                                         ...
                                         <input type="text" class="form-control" placeholder="" name="f_name" value="{{ $data->f_name }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Mobile Number</label>
                                        <input type="number" class="form-control" placeholder="" name="f_phone" value="{{ $data->f_phone }}" id="mob_no_fathet">
                            ...
                            <div class="row  third-row">
                                <div class="col-md-4">
                                    <label>Qualification</label>
                                      <input type="text" class="form-control" placeholder="" name="f_qualification"   value="{{ $data->f_qualification }}">
                                </div>
                                <div class="col-md-4">
                                    <label>Occupation</label>
                                      <input type="text" class="form-control" placeholder="" name="f_occupation" value="{{ $data->f_occupation }}">

                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Annual Income</label>
                                            <input type="text" class="form-control" placeholder="" name="f_income"  value="{{ $data->f_income }}">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Mother’s Name
                                          ...
                                          <input type="text" class="form-control" placeholder="" name="m_name" value="{{ $data->m_name }}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Mobile Number</label>
                                         <input type="number" class="form-control" placeholder="" name="m_phone" value="{{ $data->m_phone }}" id="mob_no_mother">
                            ...
                            <div class="row  third-row">
                                <div class="col-md-4">
                                    <label>Qualification</label>
                                      <input type="text" class="form-control" placeholder="" name="m_qualification" value="{{ $data->m_qualification }}">

                                </div>
                                <div class="col-md-4">
                                    <label>Occupation</label>

                                     <input type="text" class="form-control" placeholder="" name="m_occupation" value="{{ $data->m_occupation }}">

                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Annual Income</label>
                                       <input type="text" class="form-control" placeholder="" name="m_income" value="{{ $data->m_income }}">
 ...
 <h4 > Address Details</h4>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Permanent Address
                                           ...
                                           <textarea class="form-control" rows="2" id="per-1" name="address" value="{{ $data->address }}">{{ $data->address }}</textarea>
                            ...
                            <div class="row  third-row">
                                <div class="col-md-4">
                                    <label>District</label>
                                       <input type="text" class="form-control" placeholder="" name="district"  id="per-2" value="{{ $data->district }}">


                                </div>
                                <div class="col-md-4">
                                    <label>State</label>
                                     <input type="text" class="form-control" placeholder="" name="state" id="per-3" value="{{ $data->state }}">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                       ...
                                       <input type="number" class="form-control" placeholder="" id="per-4" name="pincode" value="{{ $data->pincode }}">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Correspondence Address
                                             ...
                                             <textarea class="form-control" rows="2" id="cor-1" name="cor_address" value="{{$data->cor_address }}">{{ $data->cor_address }}</textarea>
                            ...
                            <div class="row  third-row">
                                <div class="col-md-4">
                                    <label>District</label>
                                   <input type="text" class="form-control" placeholder=""  id="cor-2" name="cor_district" value="{{$data->cor_district }}">

                                </div>
                                <div class="col-md-4">
                                    <label>State</label>
                                     <input type="text" class="form-control" placeholder="" id="cor-3" name="cor_state" value="{{$data->cor_state }}">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>PIN Code</label>
                                      <input type="number" class="form-control" placeholder="" id="cor-4" name="cor_pincode" value="{{$data->cor_pincode }}">
                            ...
                            <!--    <div class="col-md-12">-->
                            <!--        <div class="form-check form-check-inline">-->
                            <!--            <input class="form-check-input" type="checkbox" id="address_same">-->
                            <!--            <label class="form-check-label" style="color: #000 !important;"> Please tick-->
                            <!--                check box. These details can’t be changed after your submit the application-->
                            <!--                form.</label>-->
                            <!--        </div>-->
                            ...
                            <div class="btn-save-sec">
                                <!--<a  onclick="history.back()" class="btn  btn-save">Back</a>-->
                                <button type="submit" class="btn btn-sb sign-up1">Submit</button></div>
                            ...
                            <div class="progress__bar__container">
                                <ul>
                                    ...
                                    <li id="icon5"><svg name="mail-outline" name="pricetag-outline" width="43"
                                            name="book-outline" name="person-outline" height="44" viewBox="0 0 43 44"
                                            fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M42.8999 25.62L42.8999 0L21.4499 17.47L-9.91821e-05 -1.87522e-06L-0.000100302 25.62L21.4499 43.09L42.8999 25.62Z" />
                                        </svg></li>
                        ...
                        <div class="right__container">
                            <div id="form1">
                                <div class="sub__title__container ">
                                    ...
                                    <p>Help us to know more about you. It will help us <br>
                                        find the right school for your child</p>
                                    <img src="images/adv-img.png" class="emoji">
                                        ...
                                        <div class="mc-field-group input-group option-flex">
                                            ...
                                            <div class="custom-radio">
                                                <div class="radio-item">
                                                    <input type="radio" value="1" name="group[274634]"
                                                        id="mce-group[274634]-274634-0" required>
                                                ...
                                                <div class="radio-item">
                                                    <input type="radio" value="2" name="group[274634]"
                                                ...
                                                <div class="radio-item">
                                                    <input type="radio" value="4" name="group[274634]"
                                                        id="mce-group[274634]-274634-3">
                                                    <label class="label-icon option2" for="mce-group[274634]-274634-3">
                                                        <div class="card-body p-0">
                                                ...
                                                <div class="radio-item">
                                                    <input type="radio" value="3" name="group[274634]"
                                                        id="mce-group[274634]-274634-2">
                                                    <label class="label-icon option2" for="mce-group[274634]-274634-2">
                                                        <div class="card-body p-0">
                            ...
                            <fieldset class="active__form" id="form2">
                                <div class="sub__title__container">
                                    ...
                                    <p>Hi ! I am looking for a School for my chind going in class<br>
                                        within fee range - <span>
                                            < 30 K and 30K to 50k and 50k to 2 70k</span> <br>
                                                and the Board of affilation -</p>

                                    <button class="borad-btn btn "><img src="{{url('public/images/book-svg.png')}}"> Board</button>
                                    ...
                                    <p class="red-text"> Board You can select muliple time </p>
                                </div>
                            ...
                            <fieldset class="active__form" id="form3">
                                <div class="sub__title__container">
                                    ...
                                    <p>Help us to know more about you. It will help us<br>
                                        find the right school for your child</p>
                                    <img src="{{url('public/images/adv-img.png')}}" class="emoji">
                                    <p>Hi ! I am looking for a School for my chind going in class</p>

                                    <button class="borad-btn btn "><img src="{{url('public/images/book-svg.png')}}"> Class</button>

                                    <section class="app">
                                        <div class="button">
                                            <input type="radio" id="a1" name="check-substitution-2" />
                                            <label class="btn btn-default" for="a1">Pre </label>
                                        </div>
                                        <div class="button">
                                            <input type="radio" id="a2" name="check-substitution-2" />
                                            <label class="btn btn-default" for="a2">Nursery</label>
                                        </div>
                                        <div class="button number-cls">
                                            <input type="radio" id="a3" name="check-substitution-2" />
                                            <label class=" btn-default" for="a3">1</label>
                                        </div>
                                        <div class="button number-cls">
                                            <input type="radio" id="a4" name="check-substitution-2" />
                                            <label class=" btn-default" for="a4">2</label>
                                        </div>

                                        <div class="button number-cls">
                                            <input type="radio" id="a5" name="check-substitution-2" />
                                            <label class=" btn-default" for="a5">3</label>
                                        </div>

                                        <div class="button number-cls">
                                            <input type="radio" id="a6" name="check-substitution-2" />
                                            <label class=" btn-default" for="a6">4</label>
                                        </div>

                                        <div class="button number-cls">
                                            <input type="radio" id="a7" name="check-substitution-2" />
                                            <label class=" btn-default" for="a7">5</label>
                                        </div>

                                        <div class="button number-cls">
                                            <input type="radio" id="a8" name="check-substitution-2" />
                                            <label class=" btn-default" for="a8">6</label>
                                        </div>

                                        <div class="button number-cls">
                                            <input type="radio" id="a9" name="check-substitution-2" />
                                            <label class=" btn-default" for="a9">7</label>
                                        </div>

                                        <div class="button number-cls">
                                            <input type="radio" id="a10" name="check-substitution-2" />
                                            <label class=" btn-default" for="a10">8</label>
                                        </div>

                                        <div class="button number-cls">
                                            <input type="radio" id="a11" name="check-substitution-2" />
                                            <label class=" btn-default" for="a12">9</label>
                                        </div>

                                        <div class="button number-cls">
                                            <input type="radio" id="a12" name="check-substitution-2" />
                                            <label class=" btn-default" for="a12">10</label>
                                        </div>

                                        <div class="button number-cls">
                                            <input type="radio" id="a13" name="check-substitution-2" />
                                            <label class=" btn-default" for="a13">11</label>
                                        </div>

                                        <div class="button number-cls">
                                            <input type="radio" id="a14" name="check-substitution-2" />
                                            <label class=" btn-default" for="a14">12</label>
                                        </div>
                            ...
                            <fieldset class="active__form" id="form4">
                                ...
                                <div class="sub__title__container">
                                    ...
                                    <p>Hi ! I am looking for a School for my chind going in class<br>
                                        within fee range -<span>
                                            < 30 K and 30K to 50k and 50k to 2 70k </span> <br> and the Board of
                                                affilation - <span> CBSE, ISCE & IB</span></p>
                            ...
                            <fieldset class="active__form" id="form5">
                                <div class="sub__title__container">
                                    ...
                                    <p>Help us to know more about you. It will help us <br>
                                        find the right school for your child</p>
                                    <img src="{{url('public/images/adv-img.png')}}" class="emoji">
                                    <p>Hi ! I am looking for a School for my chind going in class
                                        within fee range </p>
                                    ...
                                    <section class="app">
                                        ...
                                        <article class="feature1">
                                            ...
                                            <div>
                                                <span>
                                                    < 30 K </span> </div> </article> <article class="feature2">
                                                        <input type="checkbox" id="feature2" />
                                                        <div>
                                                            <span>
                                                                30K to 50K
                                    ...
                                    <p class="red-text"> *Fees You can select muliple time </p>
                                </div>
                            ...
                            <fieldset class="active__form" id="form6">
                                <div class="sub__title__container">
                                    ...
                                    <p>Help us to know more about you. It will help us<br>
                                        find the right school for your child</p>
                                    <img src="{{url('public/images/adv-img.png')}}" class="emoji">
                                    <p>Hi ! I am looking for a <span>School</span> for my chind going in class
                                        <br> within fee range - <span>
                                            < 30 K and 30K to 50k and 50k to 2 70k </span> <br> and the Board of
                                                affilation - <span> CBSE, ISCE & IB </span> around this region<br>
                                                <span>NORTHEN & EASTERN REGION</span></p>
      ...
      //mob_no_fathet----father
       //mob_no_mother----mother
        if(document.getElementById('mob_no_fathet').value.length == 0 || document.getElementById('mob_no_fathet').value.length < 10 || document.getElementById('mob_no_fathet').value.length > 10){
             alert("Please Enter Valid Father Phone Number "); 
         return false;
           
      }
       else if (document.getElementById('per-4').value.length < 6 || document.getElementById('per-4').value.length > 6 ) {
             alert("Please Enter Valid Pincode"); 
              return false;
         }
           else if (document.getElementById('cor-4').value.length < 6 || document.getElementById('cor-4').value.length > 6 ) {
             alert("Please Enter Valid Pincode"); 
              return false;
         }
        
    else {
        if(document.getElementById('mob_no_mother').value.length == 0){
        return true;
        }else if(document.getElementById('mob_no_mother').value.length < 10  || document.getElementById('mob_no_mother').value.length > 10){
              alert("Please Enter Valid Mother Number ");
            return false;
        }
        else{
             return true 
