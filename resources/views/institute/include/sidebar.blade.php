    ...
    <div class="sidebar sidebar-collapse" id="sidebar">
        <div class="sidebar__menu-group">
            <ul class="sidebar_nav">
                ...
                @if(auth()->user()->enable_admin==1)
                <!-- <li>
                            <a href="{{url('institute_dashboard')}}" class="active">
                ...
                <li class="has-child ">
                    <a href="{{url('institute_addmission',)}}" class="">
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <!--</a>-->
                            <a href="{{url('ins_select')}}">Add Products</a>
                        </li>
                        ...
                        <li>
                            <a href="{{url('ins_Institutions/'.$i->id)}}" style="padding: 0.05px 30px 17.05px 30px;">
                                {{$i->name}}</a>
                        </li>
...
@empty
                ...
                <li>
                 ...
                 @elseif($institute_premium==0)
                <!-- <li>
                            <a href="{{url('index1')}}" class="disable">
                                <span class="nav-icon"><i class="fa fa-th" aria-hidden="true"></i></span>
                                <span class="menu-text">Dashboard</span>
                ...
                <li class="has-child ">
                    ...
                    <ul>
                        <li>
                            <a href="{{url('index1')}}" style="padding: 0.05px 30px 17.05px 30px;"
                ...
                <li class="has-child ">
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <!--    style="padding: 0.05px 30px 17.05px 30px;">Add Institute-->
                            <!--</a>-->
                            <a href="{{url('ins_select')}}">Add Institution</a>
                        </li>
