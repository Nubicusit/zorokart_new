...
<div class="contents">
        ...
        <div class="container-fluid  ">
            ...
            <div class="row">
                ...
                <div class="box-my-acc school-form-box">
                    <div class="container">
                     <form action="{{url('institute_store')}}" method="post" enctype="multipart/form-data">
      @csrf
             ...
             <input type="hidden"  name="cat" value="{{$cat}}">
                            <div class="row">
                                ...
                                <div class="col-md-6  edit-form-right">
                                    ...
                                    <div class="profile-pic">
                                        ...
                                        <img alt="User Pic"
                                            src="https://silqen.in/schoolspe/public/images/upload-pic.png"
                            ...
                            <div class="row">
                                            ...
                                            <div class="form-group"><span style="color:red">&nbsp;*</span>
                                             ...
                                             <select class="form-control" name="d_status" required>
                                                <option >Select One</option> 
                                                    ...
                                                    <option value="2">All Boys</option>
                                                    <option value="3" >All Girls</option>
                                                </select>
                                ...
                                <div class="col-md-6 right-sec">
                                    ...
                                    <div class="form-group">
                                        <label>Average fee per year </label><span style="color:red">&nbsp;*</span>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                <label>Addmission Fee </label><span style="color:red">&nbsp;*</span>
    ...
    <input type='text'name='Facilities[]' class='form-control' id="taskname" style='border-radius: 3px 0px 0px 3px;'>
                                         ...
                                         <div class="form-group portfolioimgdiv width100">
                                                   ...
                                                   <div class="row">
                                                    ...
                                                    <div class="upload-demo col-lg-3" style="flex-direction: column; justify-content: center; align-content: center; gap: 10px;align-items: center;">
                                                        <div>
                                                        <img alt="your image" class="portimg" style="display:block" src="" > </div>
                                                        <div class="removebtnimg">
                                                            <a><button type="button" class="btn  btn-sm remove_field"><span class="glyphicon glyphicon-trash">Remove</span></button></a></div>
                                                    </div>
                                         ...
                                         <div class="upload-img-upload">
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="upload-demo col-md-3 " style="flex-direction: column; justify-content: center; align-content: center; gap: 10px;align-items: center;">
                                                      <div>  <video alt="your image" class="portimg-1" src="" style="display:block" ></video>
                                                        </div>
                                                        <div class="removebtnimg">
                                                            <a ><button type="button" class="btn  btn-sm remove_field"><span class="glyphicon glyphicon-trash">Remove</span></button></a></div>
                                                    </div>
  ...
  document.querySelector('#push-1').onclick = function(){
    ...
    if((document.querySelector('#newtask-1 .input-1').value.length == 0) || (document.querySelector('#newtask-1 .input-2').value.length == 0)){
        ...
        document.querySelector('#tasks-1').innerHTML += `
         <div class='col-md-9 mb-3'  style='display:flex; align-items:center; gap:40px'>   <input type='text'name='Facilities[]' class='form-control' id="taskname"  value="${document.querySelector('#newtask-1 .input-1').value}">  <input type='text'name='Facilities[]' class='form-control' id="taskname"  value="${document.querySelector('#newtask-1 .input-2').value}"> <i class='fa fa-times  delete btn btn-sb js-remove-exam' style='background: #FF4005; height: 100%; color: #fff; line-height: 1.8; width: 40px;' aria-hidden='true'></i></div>
        `;
  document.getElementById('textfield1').value = "";
