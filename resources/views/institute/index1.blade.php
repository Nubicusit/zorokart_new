                    ...
                    <div class="row">
                        ...
                        @if(0)
                            <div class="breadcrumb-main">
                                ...
                                <button style="margin: auto; margin-top: 2rem;" class="nav-btn btn btn-primary opt" data-link="{{url('get_premium')}}" id="premium"> Click here for Premium Membership</button>
                                </div>
                            </div>
@elseif(2)
<div class="breadcrumb-main">
