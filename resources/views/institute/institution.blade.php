                              ...
                              <tr>
                                  <td> Abc school</td>
                                   <td>8888 </td>
                                    <td>a@gmail.com</td>
                                    <td> 
                                <a href="{{url('edit_details_of_school')}}" class="btn btn-primary"><img src="{{url('public/img/images/edit-btn.png')}}">&nbsp;Online</a><br>
                                    
                                <a href="{{url('edit_details_of_school')}}" class="btn btn-primary"><img src="{{url('public/img/images/edit-btn.png')}}">&nbsp; 
                               Offline</a>
                                    </td>
                                    <td> 
