    ...
    <section class="content-header">
        <div class="container-fluid">
            ...
            <h4 style="color: #FF4C00!important;" class="mb-3">Search <i class="fa fa-search" aria-hidden="true"></i></h4>
              ...
              <form action="{{url('pendingapp_search')}}">
                    <div class="row">
                        <div class="col-md-3">
                                ...
                                <tbody class="cur-body">
                                    <td class="icons">
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ __($pen->application_no) }}</td>
                                            <td>{{ __($pen->name) }}</td>
                                            <td>{{ __($pen->email) }}</td>
                                             <td> {{date('d-m-y',strtotime($pen->created_at))}}</td>
                                                   
                                         


                                            <td>
                                      <a href="{{route('display_pendingapplications', $pen->id) }}" class="btn btn-success btn-sm" >
