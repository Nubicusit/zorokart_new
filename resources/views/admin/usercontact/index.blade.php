                ...
                <div class="col-12">
                    <div class="card card-outline card-primary">
                        ...
                        <div class="card-body table-responsive p-b-0">
                            ...
                            <table class="table table-hover" style="white-space:no-wrap;text-align-last:left;text-align:left">
                                <thead>
                                    <tr>
                                        <th>Sl.No.</th>
                                ...
                                <tbody class="cur-body">
                                    <td class="icons">
                                        @forelse($usercontact as $u)
                                        <tr>
                                            <td>{{ $loop->iteration }}</td>
                                            <td>
                                                                @if($u->institute==1)
                                                                Schools
                                                                @elseif($u->institute==2)
                                                                PU-Junior College
                                                                @elseif($u->institute==3)
                                                                Polytechnic College
                                                                @elseif($u->institute==4)
                                                                UG-PG College
                                            ...
                                            <td>{{ __($u->phone) }}</td>
                                            <td>{{ __($u->email) }}</td>
                                            <td style="white-space:initial; ">{{ __($u->message) }}</td>

                                           <td>
                                           <a href="{{ route('usercontact_destroy',$u->id) }}" title="Delete the item"
