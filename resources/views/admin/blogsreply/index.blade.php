    ...
    <section class="content-header">
        <div class="container-fluid">
            ...
            <div class=" mb-2 " style=" display:flex; align-items:center">
                    ...
                    <h3 style="text-align:center">Blogs Reply</h3>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card mt-3 mb-3 pl-3 pr-3 py-3">
                ...
                <form action="{{url('blogsreply_search')}} ">
                    <div class="row">
                        <div class="col-md-3">
                             <?php
                            ...
                            <select class="form-control" name="type" id="seeAnotherField" required>
                                ...
                                <option value="2"<?=$c2?>>Email</option>
                            ...
                            <table class="table table-hover text-nowrap">
                                ...
                                <tbody class="cur-body">
                                    <td class="icons">
                                        ...
                                        <tr>
                                            <td>{{ $blogsreplydata->firstItem() + $loop->index }}</td>

                                            <td>{{ __($b->name) }}</td>
                                            <td>{{ __($b->mail) }}</td>
                                            <td>{{ __($b->website) }}</td>
                                            <td style="white-space:initial">{{ __($b->message) }}</td>
...
<form   action="{{ url('blogsreply_action/'.$b->id .' ') }}" method="post" >
{{ method_field('PUT') }} 
{{ csrf_field() }}
...
<textarea col="5" row="5"  class="form-control" name="remarks" value="{{ old('remarks', $b->remarks)}}">
{{ old('remarks', $b->remarks)}}
...
<button type="submit" class="btn btn-primary">Submit</button>
                                    ...
                                    <!--        <td>-->
                                    <!--        <a href="{{ route('blogsreply_destroy',$b->id) }}" title="Delete the item"-->
