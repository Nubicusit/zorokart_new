...
<body>
    ...
    <div id="site-wrapper" class="site-wrapper starter demo-header">
        ...
        <div class="content animation-section school-edit-form">
            ...
            <section class="my-acc-home form-school">
                ...
                <div class="box-my-acc school-form-box">
                    <div class="container">
                        <form action="{{route('edit_admin_course_offered_store')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row card">
                                <div class="col-md-12 left-sec">
                                    <h4 class="edit-form-text" style="text-align:center">Courses Offered </h4>
                                    <div class="row">
                                        <div class="col-md-3 ">
                                     ...
                                     @else
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Academic streams </label>(<i>Optional</i>)
                                    ...
                                    @endif
                                        ...
                                        <div class="col-md-3">
                                            <div class="btn-save-sec">
                                                <button type="submit" class="btn btn-sb btn-primary"><i class="fa fa-plus" aria-hidden="true"></i></button>
     ...
     padding: 0rem; 
                    ...
                    <table>
                        <tr>
                            ...
                            <th><label>Course Name</label></th>
                             @if($cat=="pu")
                             @else
                            <th style="text-align:left"> <label>Stream Name</label></th>
                             @endif
                        ...
                        <tr id="{{$co->id}}">
                            <td style="width:20px"> <div class="number" style="width:30px"> {{ $loop->iteration }}</div></td>
         ...
         <a href="{{url('institution')}}?cat={{$cat}}" style="margin:auto !important"> <button class="btn btn-primary">Submit</button></a>
