        ...
        <div class="col-md-12">
            <div class="card mt-3 mb-3 pl-3 pr-3 py-3">
                <h4 style="color: #FF4C00!important;" class="mb-3">Search <i class="fa fa-search" aria-hidden="true"></i></h4>
                  ...
                  <form action="{{url('product_deta_search')}}" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-3">
...
<td>{{ __($c->order_by) }}</td>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-md-12">
                                                                                <form action="{{ route('pro_detail_update') }}" method="POST" enctype="multipart/form-data"  runat="server">
                                                                                    {{csrf_field()}}
                                                                                    @csrf
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        <label>@lang('Product detail Name')</label>
    ...
    <div class="modal fade" id="categoryModal" tabindex="-1" role="dialog" aria-labelledby="categoryModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="categoryModalLabel">@lang('Add Product Details')</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="{{'product_det_store'}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
