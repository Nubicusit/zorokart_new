    ...
    <section class="content-header">
        <div class="container-fluid">
            ...
            <div class=" mb-2 " style=" display:flex; align-items:center">
                    ...
                    <h3 style="text-align:center">Online Applications</h3>
          ...
          <form action="{{url('onlineapp_search')}}">
                    <div class="row">
                        <div class="col-md-3">
                        ...
                        <div class="card-body table-responsive p-b-0">
                            ...
                            <table class="table table-hover text-nowrap">
                                ...
                                <tbody class="cur-body">
                                    <td class="icons">
                                        @forelse( $online as $onl)
                                        <tr>
                                            <td>{{ $online->firstItem() + $loop->index }}</td>
                                            <td>{{ __($onl->application_no) }}</td>
                                            <td>{{ __($onl->name) }}</td>
                                            <td>{{ __($onl->email) }}</td>
                                            <td>{{ __($onl->f_phone) }}</td>
                                             <td> {{date('d-m-y',strtotime($onl->created_at))}}</td>
                                                   
                                         


                                            <td>
                                      <a href="{{route('display_onlineapplications', $onl->id) }}" class="btn btn-success btn-sm" >
