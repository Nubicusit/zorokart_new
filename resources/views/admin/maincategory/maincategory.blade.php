...
<td>{{ __($c->order_by) }}</td>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-md-12">
                                                                                <form action="{{ route('maincat_update') }}" method="POST" enctype="multipart/form-data"  runat="server">
                                                                                    {{csrf_field()}}
                                                                                    @csrf
                                                                                   ...
                                                                                   <input type="file" id="img" name="image" accept="image/*">
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <input type="text" name="caption" class="form-control" required value="{{ old('name', $c->caption) }}">
                                                                                        @if ($errors->has('name'))
                                                                                        <span class="text-danger" style="font-weight:bold">{{ $errors->first('caption') }}</span>
                                                                                        @endif

                                                                                    </div>
                                                                                    <div class="form-group">
                                                                                        <label>@lang('order')</label>
                                                                                        <input type="text" name="order" class="form-control" required value="{{ old('name', $c->order_by) }}">
                                                                                        @if ($errors->has('order'))
                                                                                        <span class="text-danger" style="font-weight:bold">{{ $errors->first('order') }}</span>
                                                                                        @endif
    ...
    <div class="modal fade" id="categoryModal" tabindex="-1" role="dialog" aria-labelledby="categoryModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="categoryModalLabel">@lang('Add Main Category')</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="{{'maincat_store'}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
