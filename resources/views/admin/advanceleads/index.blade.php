    ...
    <section class="content-header">
        <div class="container-fluid">
            ...
            <div class=" mb-2 " style=" display:flex; align-items:center">
                    ...
                    <h3 style="text-align:center">Advance Leads</h3>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card mt-3 mb-3 pl-3 pr-3 py-3">
                ...
                <form action="{{url('advancelead_search')}} ">
                    <div class="row">
                        <div class="col-md-3">
                           <?php
                            ...
                            <table class="table table-hover text-nowrap">
                                ...
                                <tbody class="cur-body">
                                    <td class="icons">
                                        ...
                                        <tr>
                                           <td>{{ $advanceleads->firstItem() + $loop->index }}</td>
...
<form   action="{{ url('lead_action/'.$a->id .' ') }}" method="post" >
{{ method_field('PUT') }} 
{{ csrf_field() }}
...
<textarea col="5" row="5"  class="form-control" name="remarks" value="{{ old('remarks', $a->remarks)}}">
{{ old('remarks', $a->remarks)}}
...
<button type="submit" class="btn btn-primary">Submit</button>
                                    ...
                                    <!--        <td>-->
                                    <!--        <a href="{{ route('advancelead_destroy',$a->id) }}" title="Delete the item"-->
